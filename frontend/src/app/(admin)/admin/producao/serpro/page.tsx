...
export default function SerproPage() {
  ...
  const [showCertPwd, setShowCertPwd] = useState(false);
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-6 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full border border-gray-200 rounded-lg pl-3 pr-10 py-2 text-sm font-mono"
                ...
                <button
                  ...
                  className="absolute inset-y-0 right-0 px-3 text-gray-400 hover:text-gray-700 transition-colors"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  type={showCertPwd ? 'text' : 'password'}
                  className="w-full border border-gray-200 rounded-lg pl-3 pr-10 py-2 text-sm"
                  value={form.certPassword}
                  onChange={e => setForm(f => ({ ...f, certPassword: e.target.value }))}
                  placeholder="Somente para producao"
                />
                <button
                  type="button"
                  onClick={() => setShowCertPwd(s => !s)}
                  className="absolute inset-y-0 right-0 px-3 text-gray-400 hover:text-gray-700 transition-colors"
                  title={showCertPwd ? 'Ocultar' : 'Mostrar'}
                  tabIndex={-1}
                >
                  {showCertPwd ? (
                    <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21"/></svg>
