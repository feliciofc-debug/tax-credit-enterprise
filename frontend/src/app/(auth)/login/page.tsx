    ...
    try {
      ...
      switch (data.data.user.role) {
        case 'admin':
          ...
          break;
        case 'partner':
          router.push('/parceiro/viabilidade');
          break;
        default:
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mt-6 space-y-3">
            ...
            <div className="flex gap-3">
              <Link
                href="/parceiro-login"
                className="flex-1 py-2.5 text-center text-sm font-medium text-brand-700 bg-brand-50 hover:bg-brand-100 border border-brand-200 rounded-lg transition-colors"
              >
                Sou Parceiro
              </Link>
              <Link
                href="/cadastro"
                className="flex-1 py-2.5 text-center text-sm font-medium text-gray-700 bg-gray-50 hover:bg-gray-100 border border-gray-200 rounded-lg transition-colors"
              >
                Criar Conta
              </Link>
            </div>
