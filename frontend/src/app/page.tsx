...
const features = [
  {
    ...
    description: 'Inteligência Artificial analisa DREs, Balanços e Balancetes identificando créditos tributários ocultos automaticamente.',
  ...
  },
  {
    ...
    description: 'Envie até 200 documentos de uma vez. 5 workers paralelos processam tudo automaticamente.',
    icon: 'M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z',
  },
  {
    title: 'Documentação Automática',
    description: 'Gera memórias de cálculo, pareceres técnicos, petições e planilhas prontas para protocolo.',
    icon: 'M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 002.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 00-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 00.75-.75 2.25 2.25 0 00-.1-.664m-5.8 0A2.251 2.251 0 0113.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m0 0H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V9.375c0-.621-.504-1.125-1.125-1.125H8.25z',
  },
  {
    title: 'Preparação e-CAC',
  ...
  },
  {
    ...
    description: 'Dashboards consolidados, exportação Excel, timeline de oportunidades e ranking por valor.',
    icon: 'M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 013 19.875v-6.75zM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V8.625zM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V4.125z',
  },
];

const stats = [
  { value: 'R$ 2.8M+', label: 'Créditos identificados' },
        ...
        <div className="relative max-w-6xl mx-auto px-6 pt-20 pb-28">
          <div className="max-w-3xl">
            ...
            <h1 className="text-5xl lg:text-6xl font-extrabold text-gray-900 leading-tight mb-6">
              Recupere créditos tributários com{' '}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-600 to-brand-800">
                inteligência artificial
              </span>
            </h1>
            <p className="text-xl text-gray-600 leading-relaxed mb-10 max-w-2xl">
              Análise automatizada de DREs, Balanços e Balancetes. Identifique oportunidades de 
              IRPJ, CSLL, PIS, COFINS, ICMS e ISS em minutos, não em semanas.
            </p>
      ...
      <section id="features" className="max-w-6xl mx-auto px-6 py-24">
        <div className="text-center mb-16">
          <h2 className="text-3xl lg:text-4xl font-extrabold text-gray-900 mb-4">
            Tudo que você precisa para recuperar créditos
          </h2>
          <p className="text-lg text-gray-500 max-w-2xl mx-auto">
            Da análise do documento até o protocolo no e-CAC. Automação completa do processo de recuperação tributária.
          </p>
        </div>
      ...
      <section className="bg-gray-50 border-y border-gray-200">
        <div className="max-w-6xl mx-auto px-6 py-24">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-500">3 passos simples para recuperar seus créditos</p>
          </div>
            ...
            {[
              {
                ...
                description: 'Envie DREs, Balanços Patrimoniais e Balancetes em PDF, Excel ou imagem. Até 200 arquivos por lote.',
                color: 'from-brand-500 to-brand-700',
              },
              {
                step: '02',
                title: 'Análise com IA',
                description: 'IA avançada analisa cada documento identificando oportunidades de crédito tributário com fundamentação legal.',
                color: 'from-blue-500 to-blue-700',
              },
              {
                step: '03',
                title: 'Documentação Pronta',
                description: 'Receba pareceres técnicos, petições e dados formatados para protocolar diretamente no e-CAC.',
        ...
        <div className="bg-gradient-to-br from-brand-700 via-brand-800 to-brand-900 rounded-3xl p-12 lg:p-16 text-center relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <p className="text-brand-200 text-lg mb-10 max-w-xl mx-auto">
              Comece agora e descubra quanto sua empresa pode recuperar em créditos tributários.
            </p>
